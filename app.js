$(document).ready(function() {
        ...
        apiKey: "AIzaSyABaqv70FSfnAdzMXkx1a72hDJ7WvViKTs",
      authDomain: "muebleriarada-6704b.firebaseapp.com",
      databaseURL: "https://muebleriarada-6704b.firebaseio.com",
      projectId: "muebleriarada-6704b",
      storageBucket: "muebleriarada-6704b.appspot.com",
      messagingSenderId: "536830315050",
      appId: "1:536830315050:web:8f75ef75be4bf3f3075153",
    };    
    ...
    var coleccionProductos = db.ref().child("Salidaproductos");
    ...
    coleccionProductos.on("child_added", datos => {        
        dataSet = [datos.key,datos.child("linea").val(), datos.child("codigo").val(), datos.child("descripcion").val(), datos.child("cantidad").val(), datos.child("motivo").val()];
    ...
    $('form').submit(function(e){                         
        ...
        data = {linea:linea, codigo:codigo, descripcion: descripcion, cantidad: cantidad, motivo:motivo};             
        actualizacionData = {};
    ...
    $("#tablaProductos").on("click", ".btnEditar", function() {    
        ...
        let id = fila[0];
        console.log(id);
		let linea = $(this).closest('tr').find('td:eq(0)').text();
        ...
        let motivo = $(this).closest('tr').find('td:eq(4)').text();      
        $('#id').val(id);
        $('#linea').val(linea);
        $('#codigo').val(codigo);
